...
class Complex:
    ...
    def __truediv__(self,other):
    	if type(other) == type(self):
    		final = (other.real * other.real) + (other.imag * other.imag)
            real = ((self.real * other.real) + (self.imag * other.imag))/final
      		imag = ((self.imag * other.real) - (self.real * other.imag))/final   
            return Complex(real,imag)
        else:
            raise TypeError('TypeError: unsupported operand type') 
